...
public class SQLite extends Database {
    ...
    public SQLite(MagishaComputerDivision instance) {
        super(instance);
        dbname = "computers";
    }
    ...
    public Connection getSQLConnection() {
        File dataFolder = MagishaComputerDivision.getPlugin().getDataFolder();
        File dataFile = new File(MagishaComputerDivision.getPlugin().getDataFolder(), dbname + ".db");
        ...
        if (!dataFile.exists()) {
            try {
                ...
                MagishaComputerDivision.getPlugin().getLogger().log(Level.SEVERE, "File write error: " + dbname + ".db");
            }
        }
        try {
            ...
            MagishaComputerDivision.getPlugin().getLogger().log(Level.SEVERE, "SQLite exception on initialize", ex);
        } catch (ClassNotFoundException ex) {
            MagishaComputerDivision.getPlugin().getLogger().log(Level.SEVERE, "You need the SQLite JBDC library. Google it. Put it in /lib folder.");
        }
        return null;
    }
    ...
    public ResultSet executeQuery(String command) {
        ...
        try {
            ...
            MagishaComputerDivision.getPlugin().getLogger().severe("Unable to execute query. FIX THIS ASAP!");
    ...
    public boolean tableContainsValue(String value) {
        ...
        try {
            ...
            MagishaComputerDivision.getPlugin().getLogger().severe("Failed to check if table contains value");
