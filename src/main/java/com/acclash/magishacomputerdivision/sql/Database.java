...
public abstract class Database {
    MagishaComputerDivision plugin;
    Connection connection;
    // The name of the table we created back in SQLite class.
    public String table = "computers";
    public int tokens = 0;
    public Database(MagishaComputerDivision instance){
        plugin = instance;
    }
    ...
    public void initialize(){
        ...
        //} catch (SQLException ex) {
          //  MagishaComputerDivision.getPlugin().getLogger().log(Level.SEVERE, "Unable to retreive connection", ex);
        //}
    }
    ...
    public Integer getTokens(String string) {
        ...
        try {
            ...
            MagishaComputerDivision.getPlugin().getLogger().log(Level.SEVERE, Errors.sqlConnectionExecute(), ex);
        } finally {
            try {
                if (ps != null)
                    ps.close();
                ...
                MagishaComputerDivision.getPlugin().getLogger().log(Level.SEVERE, Errors.sqlConnectionClose(), ex);
            }
        }
        return 0;
    }
