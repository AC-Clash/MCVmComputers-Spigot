...
import com.acclash.projectmagisha.commands.computersubcommands.Create;
import com.acclash.projectmagisha.commands.computersubcommands.Remove;
...
public class ComputerCM implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player player) {
            ...
            player.sendMessage(ChatColor.RED + "This version of VM Computers is deprecated. Please use the version in the Magisha Computer Division");
            if (args.length == 0) {
