...
public class Dos_misc {
    ...
    static private final Callback.Handler INT2F_Handler = new Callback.Handler() {
        ...
        public /*Bitu*/int call() {
            for (int i=0;i<Multiplex.size();i++) {
             ...
             Log.specializedLog(LogType.LOG_DOSMISC, Level.ERROR,"DOS:Multiplex Unhandled call "+Integer.toString(CPU_Regs.reg_eax.word(),16));
            return Callback.CBRET_NONE;
        }
    };
    ...
    static final Dos_system.MultiplexHandler DOS_MultiplexFunctions = () -> {
        ...
        case 0x1216:	/* GET ADDRESS OF SYSTEM FILE TABLE ENTRY */
            ...
            Log.specializedLog(LogType.LOG_DOSMISC,Level.ERROR,"Some BAD filetable call used bx="+Integer.toString(CPU_Regs.reg_ebx.word(),16));
        ...
        case 0x4a02:	/* ALLOCATE HMA SPACE */
            Log.specializedLog(LogType.LOG_DOSMISC,Level.WARN,"INT 2f:4a HMA. DOSBox reports none available.");
