                    ...
                    if (c == '%') {
                        ...
                        if (c == 'c') {
                            if (args[argIndex] instanceof Character) {
                                ...
                                Log.getLogger().info("Invalid printf argument type for %c: "+args[argIndex].getClass());
                                return buffer.toString();
                            }
                            if (value.length()>1)
                            ...
                            if (args[argIndex] instanceof Character) {
                                ...
                                Log.getLogger().info("Invalid printf argument type for %s: "+args[argIndex].getClass());
                                return buffer.toString();
                            }
                            ...
                            if (args[argIndex] instanceof Integer) {
                                ...
                                Log.getLogger().info("Invalid printf argument type for %x: "+args[argIndex].getClass());
                                return buffer.toString();
                            }
                            ...
                            if (args[argIndex] instanceof Integer) {
                                ...
                                Log.getLogger().info("Invalid printf argument type for %d: "+args[argIndex].getClass());
                                return buffer.toString();
                            }
                            negnumber = value.toString().startsWith("-");
                            if (negnumber)
                            ...
                            if (args[argIndex] instanceof Double) {
                                ...
                                Log.getLogger().info("Invalid printf argument type for %f: "+args[argIndex].getClass());
                                return buffer.toString();
                            }
                            negnumber = value.toString().startsWith("-");
                            if (negnumber)
