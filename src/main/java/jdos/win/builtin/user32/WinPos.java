...
public class WinPos extends WinAPI {
    ...
    public static int SetWindowPos(int hWnd, int hWndInsertAfter, int X, int Y, int cx, int cy, int uFlags) {
        ...
        boolean geometryChanged = window.rectWindow.width() != newWindowRect.width() || window.rectWindow.height() != newWindowRect.height() || window.rectWindow.left != newWindowRect.left || window.rectWindow.top != newWindowRect.top;
