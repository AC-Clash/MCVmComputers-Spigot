...
public class Prefix_none extends StringOp {
    ...
    static {
        ...
        ops[0x8c] = () -> {
            ...
            default:
                  Log.specializedLog(LogType.LOG_CPU, Level.ERROR,"CPU:8c:Illegal RM Byte");
        ...
        ops[0xd8] = () -> {
            if (Config.C_FPU)
            {
                ...
                /*Bit8u*/int rm=Fetchb();
                Log.specializedLog(LogType.LOG_CPU,Level.INFO,"FPU used");
        ...
        /* LOCK */
        ops[0xf0] = () -> {
            //Log.specializedLog(LogType.LOG_CPU,Level.INFO,"CPU:LOCK"); /* FIXME: see case D_LOCK in core_full/new Instructions.load()h */
        ...
        ops[0xff] = () -> {
            ...
            case 0x06:										/* PUSH Ev */
                ...
                break;
            default:
                if (Log.level<=LogSeverities.LOG_ERROR.getValue()) Log.specializedLog(LogType.LOG_CPU,Level.ERROR,"CPU:GRP5:Illegal Call "+Integer.toString(which,16));
                return ILLEGAL_OPCODE;
            }
            return HANDLED;
        };
