    ...
    //		VGA_DetermineMode();
        ...
        default:
            if (VGA.svga.write_p3d5!=null) {
                ...
                Log.specializedLog(LogType.LOG_VGAMISC, Level.INFO,"VGA:CRTC:Write to unknown index "+Integer.toString(VGA.vga.crtc.index,16));
            }
            break;
        }
    };
    ...
    //	LOG_MSG("VGA CRCT read from reg %X",VGA.vga.crtc.index));
        ...
        default:
            if (VGA.svga.read_p3d5!=null) {
                ...
                Log.specializedLog(LogType.LOG_VGAMISC, Level.INFO,"VGA:CRTC:Read from unknown index "+Integer.toString(VGA.vga.crtc.index,16));
                return 0x0;
            }
        }
    };
