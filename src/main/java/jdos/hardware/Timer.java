...
public class Timer extends Module_base {
    ...
    static boolean counter_output(/*Bitu*/int counter) {
        ...
        case 4:
            ...
            return true;
        default:
            Log.specializedLog(LogType.LOG_PIT, Level.ERROR,"Illegal Mode "+p.mode+" for reading output");
            return true;
        }
    }
    static private void status_latch(/*Bitu*/int counter) {
        ...
        if(!latched_timerstatus_locked)	{
            ...
            latched_timerstatus|= (short) ((p.mode&7)<<1);
    ...
    static void counter_latch(/*Bitu*/int counter) {
        ...
        case 3:		/* Square Wave Rate Generator */
            ...
            break;
        default:
            Log.specializedLog(LogType.LOG_PIT,Level.ERROR,"Illegal Mode "+p.mode+" for reading counter "+counter);
            p.read_latch=0xffff;
            break;
        }
    }
    ...
    //Log.specializedLog(LogType.LOG_PIT,Level.ERROR,"port %X write:%X state:%X",port,val,pit[port-0x40].write_state);
        ...
        if (p.write_state != 0) {
            ...
            case 0x00:			/* Timer hooked to IRQ 0 */
                ...
                } else Log.specializedLog(LogType.LOG_PIT,Level.INFO,"PIT 0 Timer set without new control word");
                Log.specializedLog(LogType.LOG_PIT,Level.INFO,"PIT 0 Timer at "+ StringHelper.format(1000.0/p.delay, 4)+" Hz mode "+p.mode);
                break;
    ...
    //			LOG(LOG_PIT,"PIT 2 Timer at %.3g Hz mode %d",PIT_TICK_RATE/(double)p.cntr,p.mode);
                ...
                break;
            default:
                Log.specializedLog(LogType.LOG_PIT,Level.ERROR,"PIT:Illegal timer selected for writing");
            }
            p.new_mode=false;
        }
    };
    ...
    static private final IoHandler.IO_ReadHandler read_latch = new IoHandler.IO_ReadHandler() {
        ...
        //Log.specializedLog(LogType.LOG_PIT,Level.ERROR,"port read %X",port);
            ...
            if(pit[counter].counterstatus_set){
                ...
                case 2: /* read MSB */
                    ...
                    break;
                default:
                    Log.exit("Timer.cpp: error in readlatch", Level.ERROR);
                    break;
                }
    ...
    static private final IoHandler.IO_WriteHandler write_p43 = new IoHandler.IO_WriteHandler() {
        ...
        //Log.specializedLog(LogType.LOG_PIT,Level.ERROR,"port 43 %X",val);
    ...
    static public void TIMER_SetGate2(boolean in) {
        ...
        case 4:
        case 5:
            Log.specializedLog(LogType.LOG_MISC,Level.WARN,"unsupported gate 2 mode "+Integer.toString(pit[2].mode,16));
            break;
        }
