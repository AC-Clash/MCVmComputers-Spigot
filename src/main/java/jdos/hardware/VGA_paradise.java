...
//       anything and actually works in WHATVGA just fine.
    ...
    static private final VGA.tWritePort write_p3cf_pvga1a = (reg, val, iolen) -> {
        ...
        case 0x0f:
            ...
            break;
        default:
            Log.specializedLog(LogType.LOG_VGAMISC, Level.INFO,"VGA:GFX:PVGA1A:Write to illegal index "+Integer.toString(reg,16));
            break;
        }
    };
    ...
    static private final VGA.tReadPort read_p3cf_pvga1a = (reg, iolen) -> {
        ...
        case 0x0f:
            return pvga1a.PR5;
        default:
            Log.specializedLog(LogType.LOG_VGAMISC,Level.INFO,"VGA:GFX:PVGA1A:Read from illegal index "+Integer.toString(reg,16));
            break;
        }
        return 0x0;
    };
