...
public class VGA_attr {
        ...
        if (!VGA.vga.internal.attrindex) {
            ...
            */
            ...
            default:
                ...
                Log.specializedLog(LogType.LOG_VGAMISC, Level.INFO,"VGA:ATTR:Write to unkown Index "+Integer.toString(VGA.vga.attr.index,16));
                break;
            }
        }
    };
    ...
    //	vga.internal.attrindex=false;
        ...
        default:
            ...
            Log.specializedLog(LogType.LOG_VGAMISC,Level.INFO,"VGA:ATTR:Read from unkown Index "+Integer.toString(VGA.vga.attr.index,16));
        }
        return 0;
    };
